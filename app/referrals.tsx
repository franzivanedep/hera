    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.inviteText}>
          Invite friends and earn up to <Text style={styles.highlight}>50 points</Text>
        </Text>

        <View style={styles.offerTimer}>
          <Ionicons name="time-outline" size={16} color="#b48a64" />
          <Text style={styles.offerText}>
            Offer ends in <Text style={styles.timer}>12h 30m 58s</Text>
          </Text>
        </View>

        <Text style={styles.description}>
          For every friend who signs up using your code and completes their first appointment, you’ll earn{' '}
          <Text style={styles.highlight}>50 points</Text>. Up to 3 friends per cycle.
        </Text>
      </View>
      ...
      <View style={styles.codeCard}>
        ...
        <View style={styles.codeBox}>
          <Text style={styles.code}>HERA-AB12CD</Text>
      ...
      <View style={styles.divider}>
        ...
        <Text style={styles.dividerText}>Share your beauty, share your points!</Text>
      </View>
      ...
      <Text style={styles.footerText}>
        Rewards will be credited after your friend’s first completed appointment. Terms apply.
      </Text>
    </ScrollView>
  );
}
