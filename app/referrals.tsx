    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.description}>
          For every friend who signs up using your code and completes their
          first appointment, you’ll earn{" "}
          <Text style={styles.highlight}>50 points</Text>. Up to 3 friends per
          cycle.
        </Text>
      </View>
